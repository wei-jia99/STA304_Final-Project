...
### Model
This study uses logistic model because it is suitable for analyzing relationship between binary dependent variable and a groupd of independent variables.

Here is the general model of the logictic model:
